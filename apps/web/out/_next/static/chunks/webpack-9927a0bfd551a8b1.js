try {
  ...
  t &&
    ...
    (e._sentryDebugIds[t] = 'ed0be3a0-6110-4e31-90d3-72a91f32fc12'),
    (e._sentryDebugIdIdentifier = 'sentry-dbid-ed0be3a0-6110-4e31-90d3-72a91f32fc12'))
} catch (e) {}
;(() => {
  var e = {},
    t = {}
  ...
  ;(r.m = e),
    ...
    (() => {
      ...
      r.l = (o, n, a, i) => {
        ...
        if (void 0 !== a)
          for (var d, l, u = document.getElementsByTagName('script'), f = 0; f < u.length; f++) {
            var s = u[f]
        ...
        var c = (t, r) => {
          ...
          p = setTimeout(c.bind(null, void 0, { type: 'timeout', target: d }), 12e4)
    ...
    (r.p = '/boxing-directory/_next/'),
    (() => {
      var e = { 68: 0, 640: 0, 262: 0 }
      ;(r.f.j = (t, o) => {
        var n = r.o(e, t) ? e[t] : void 0
        if (0 !== n) {
          if (n) o.push(n[2])
          else if (/^(262|640|68)$/.test(t)) e[t] = 0
          else {
