try {
  ...
  s &&
    ...
    (e._sentryDebugIds[s] = '69fb113d-306c-41c2-9f74-db53fc963b79'),
    (e._sentryDebugIdIdentifier = 'sentry-dbid-69fb113d-306c-41c2-9f74-db53fc963b79'))
} catch (e) {}
    ...
    7464: (e, s, t) => {
      ...
      function m(e) {
        ...
        return (0, a.jsx)(l.q7, {
          ...
          'data-variant': m.variant || n,
          'data-size': m.size || r,
          className: (0, d.cn)(
            o({ variant: m.variant || n, size: m.size || r }),
      ...
      function w(e) {
        ...
        return (0, a.jsxs)('div', {
          ...
          children: [
            (0, a.jsx)(j.A, { className: 'h-16 w-16 text-muted-foreground mb-4' }),
      ...
      function z(e) {
        ...
        ;(0, i.useEffect)(() => {
          let e = [...s]
          'all' !== C && (e = e.filter(e => e.proDivision === C)),
            'wins' === R
