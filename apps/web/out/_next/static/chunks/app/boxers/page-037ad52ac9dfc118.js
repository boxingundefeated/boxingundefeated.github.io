try {
  ...
  s &&
    ...
    (e._sentryDebugIds[s] = 'fab49aa5-cad2-46d8-9c8c-55a471577d79'),
    (e._sentryDebugIdIdentifier = 'sentry-dbid-fab49aa5-cad2-46d8-9c8c-55a471577d79'))
} catch (e) {}
  ...
  [96],
  {
    ...
    7464: (e, s, t) => {
      ...
      let o = (0, t(615).F)(
        ...
        c = r.createContext({ size: 'default', variant: 'default' })
      function x(e) {
      ...
      function m(e) {
        let { className: s, children: t, variant: i, size: n, ...x } = e,
          m = r.useContext(c)
        return (0, a.jsx)(l.q7, {
          'data-slot': 'toggle-group-item',
          'data-variant': m.variant || i,
          'data-size': m.size || n,
          className: (0, d.cn)(
            o({ variant: m.variant || i, size: m.size || n }),
      ...
      var u = t(4736),
        ...
        N = t(3332)
      function w(e) {
        let { title: s, description: t, actionLabel: n, actionHref: r } = e
        return (0, a.jsxs)('div', {
          className: 'flex flex-col items-center justify-center h-[50vh] text-center',
          children: [
            (0, a.jsx)(N.A, { className: 'h-16 w-16 text-muted-foreground mb-4' }),
            ...
            (0, a.jsx)(i.$, { asChild: !0, children: (0, a.jsx)(b(), { href: r, children: n }) })
          ]
        })
      }
      var y = t(2733)
      function z(e) {
        let { initialBoxers: s } = e,
          t = (0, p.useRouter)(),
          l = (0, p.useSearchParams)(),
          [d, o] = (0, r.useState)('grid'),
          [c, j] = (0, r.useState)(s),
          [N, z] = (0, r.useState)(1),
          k = l.get('division') || 'all',
          _ = l.get('sort') || 'wins',
          [C, D] = (0, r.useState)(k),
          [R, S] = (0, r.useState)(_),
          I = (0, y.Bn)()
        ;(0, r.useEffect)(() => {
          let e = l.get('division') || 'all',
            s = l.get('sort') || 'wins',
            t = parseInt(l.get('page') || '1')
          D(e), S(s), z(t)
        }, [l])
        let A = (e, s, a) => {
          let i = new URLSearchParams()
          e && 'all' !== e && i.set('division', e),
            s && 'wins' !== s && i.set('sort', s),
            a && 1 !== a && i.set('page', a.toString())
          let n = i.toString()
          t.push('/boxers'.concat(n ? '?'.concat(n) : ''))
        }
        ;(0, r.useEffect)(() => {
          let e = [...s]
          if ('all' !== C) {
            let s = I.find(e => e.slug === C),
              t = s ? s.division : C
            e = e.filter(e => e.proDivision === t)
          }
          'wins' === R
            ? e.sort((e, s) => (s.proWins || 0) - (e.proWins || 0))
            : 'name' === R
              ? e.sort((e, s) => e.name.localeCompare(s.name))
              : 'bouts' === R && e.sort((e, s) => (s.proTotalBouts || 0) - (e.proTotalBouts || 0)),
            j(e),
            z(1)
        }, [s, C, R])
        let $ = Math.ceil(c.length / 48),
          B = (N - 1) * 48,
          P = B + 48,
          E = c.slice(B, P),
          M = e => {
          ...
          children: [
            ...
            (0, a.jsx)('div', {
              ...
              children: (0, a.jsxs)('div', {
                ...
                children: [
                  (0, a.jsx)(i.$, {
                    variant: 'all' === C ? 'default' : 'secondary',
                    size: 'sm',
                    onClick: () => {
                      D('all'), A('all', R, 1)
                    },
                  ...
                  I.map(e =>
                    (0, a.jsx)(
                      i.$,
                      {
                        variant: C === e.slug ? 'default' : 'secondary',
                        size: 'sm',
                        onClick: () => {
                          D(e.slug), A(e.slug, R, 1)
                        },
                        className: 'rounded-full',
                        children: e.name
                      },
                ...
                (0, a.jsxs)('div', {
                  ...
                  children: [
                    (0, a.jsx)(i.$, {
                      ...
                      size: 'sm',
                      onClick: () => o('grid'),
                      children: (0, a.jsx)(u.A, { className: 'size-4' })
                    }),
                    (0, a.jsx)(i.$, {
                  ...
                  children: [
                    'grid' === d
                      ? (0, a.jsx)('div', {
                          ...
                          children: E.map(e => (0, a.jsx)(M, { boxer: e }, e.id))
                        })
                      : (0, a.jsx)('div', {
                          className: 'space-y-2',
                          children: E.map(e => (0, a.jsx)(W, { boxer: e }, e.id))
                        }),
                    $ > 1 &&
                      (0, a.jsxs)('div', {
                        ...
                        children: [
                          ...
                          (0, a.jsx)('div', {
                            ...
                            children: Array.from({ length: Math.min(5, $) }, (e, s) => {
                              let t
                              return (
                                (t =
                                  $ <= 5
