try {
  ...
  t &&
    ...
    (e._sentryDebugIds[t] = 'ec77b1fd-9838-4d14-a824-287854ee65b3'),
    (e._sentryDebugIdIdentifier = 'sentry-dbid-ec77b1fd-9838-4d14-a824-287854ee65b3'))
} catch (e) {}
    ...
    6380: (e, t, r) => {
      ...
      function c(e) {
        let { href: t, children: r, exact: o = !1 } = e,
          n = (0, a.usePathname)(),
          i = o ? n === t : n.startsWith(t)
        return (0, s.jsx)(u(), {
          href: t,
          className: 'text-sm transition-colors '.concat(
            i ? 'text-foreground font-medium' : 'text-muted-foreground hover:text-foreground'
          ),
          children: r
        })
      }
        ...
        let [e, t] = (0, i.useState)(!1),
          {
            ...
            return {
              ...
              handleSearch: (0, i.useCallback)(
                async e =>
                  e.trim()
                    ? new Promise(t => {
                        let r = ''.concat(n('search'), '?q=').concat(encodeURIComponent(e))
                        s.push(r),
                          setTimeout(() => {
                            t()
                          }, 100)
                ...
                (0, s.jsxs)('div', {
                  ...
                  children: [
                    ...
                    (0, s.jsxs)('nav', {
                      ...
                      children: [
                        (0, s.jsx)(c, { href: n('website.list'), children: 'Boxers' }),
                        (0, s.jsx)(c, { href: n('about'), children: 'About' }),
                        (0, s.jsx)(c, { href: n('search'), children: 'Search' })
                      ]
                    })
                  ]
                }),
                (0, s.jsxs)('div', {
                  ...
                  children: [
                    ...
                    (0, s.jsx)('button', {
                      ...
                      children: (0, s.jsx)(l.A, { className: 'h-5 w-5' })
                    })
                  ]
                })
              ]
